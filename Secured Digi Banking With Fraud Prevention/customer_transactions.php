            ...
            <div class="container">
                ...
                <div class="duration-container">
                    <div class="date-container">
                        <input id="datefields" id="date" type="date" placeholder="From" name="date_from" min='1899-01-01' max='2000-13-13'>
                        <!--Date range-->
                        <script>
                            var today = new Date();
                    ...
                    <p id="minus">&minus;<b></b></p>

                    <div class="date-container">
                        <input id="datefield" id="date" type="date" placeholder="Upto" name="date_to" min='1899-01-01' max='2000-13-13'>
                        <!--Date range-->
                        <script>
                            var today = new Date();
                            var dd = today.getDate();
