...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="/netbanking/customer_home.php">Home</a>
        <a href="/netbanking/customer_transactions.php">My Transactions</a>
        <a id="label">Send/Recieve</a>
        <a href="/netbanking/beneficiary.php">Transfer Funds</a>
        <a href="/netbanking/atm_simulator.php">ATM Simulator</a>
        <a id="label">My Info</a>
        <a href="/netbanking/customer_home.php">Current Status</a>
        <a href="/netbanking/News Checker/index.php">Check My News</a>
...
// The Function below is jquery-3 function which is used for making the navbar sticky
$(document).ready(function() {
