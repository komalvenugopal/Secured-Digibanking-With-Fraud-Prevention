    ...
    <form class="add_customer_form" action="customer_profile_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="email" size="30" type="text" onblur="validateEmail(this);" value="<?php echo $email ?>" required />
                <script>
        ...
        <div class="flex-container">
            <div class="container">
                <a href="/netbanking/customer_home.php" class="button">Home</a>
            </div>
            <div class="container">
                <button type="submit">Update</button>
            </div>
            <div class="container">
                <a href="/netbanking/pass_change.php" class="password-button">Change Password/PIN</a>
            </div>
        </div>
