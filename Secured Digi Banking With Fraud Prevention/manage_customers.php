    ...
    <div class="flex-container">
            ...
            <div class="flex-item-1">
                <div class="dropdown">
                    ...
                    <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                        <a href="/netbanking/edit_customer.php?cust_id=<?php echo $row["cust_id"] ?>">View / Edit</a>
                        <a href="/netbanking/transactions.php?cust_id=<?php echo $row["cust_id"] ?>">Transactions</a>
                        <a href="/netbanking/delete_customer.php?cust_id=<?php echo $row["cust_id"] ?>" onclick="return confirm('Are you sure?')">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex-container-bb">
            <div class="back_button">
                <a href="/netbanking/manage_customers.php" class="button">Go Back</a>
            </div>
        </div>
        <?php }
            $conn->close(); ?>
