...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="/netbanking/admin_home.php">Home</a>
        <a id="label">My Customers</a>
        <a href="/netbanking/customer_add.php">Add Customer</a>
        <a href="/netbanking/manage_customers.php">Manage Customers</a>
        <a id="label">Website Management</a>
        <a href="/netbanking/post_news.php">Post News</a>
    </div>
